...
var MappableMap = /** @class */ (function (_super) {
    ...
    MappableMap.prototype.setIndoorLevel = function (indoorLevelId) {
        react_native_1.UIManager.dispatchViewManagerCommand((0, react_native_1.findNodeHandle)(this), this.getCommand("setIndoorLevel"), [indoorLevelId]);
    };
    ...
    MappableMap.prototype._findRoutes = function (points, vehicles, callback) {
        ...
        var args = react_native_1.Platform.OS === "ios"
            ? [{ points: points, vehicles: vehicles, id: cbId }]
    ...
    MappableMap.prototype.getCommand = function (cmd) {
        return react_native_1.Platform.OS === "ios"
            ? react_native_1.UIManager.getViewManagerConfig("MappableView").Commands[cmd]
            : cmd;
    };
